...
const renderProjectSpec = () => {
  const target = $("#projectSpecDocument");
  const source = $("#projectSpecMarkdown");
  if (!target || !source) return;
  target.innerHTML = renderMarkdownDocument(source.textContent.trim());
};
